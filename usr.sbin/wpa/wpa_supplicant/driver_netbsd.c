/*	$NetBSD: driver_netbsd.c,v 1.1.4.1 2007/05/12 15:32:53 pavel Exp $	*/
 ...
 *
 * Based on:
 * $FreeBSD: /usr/local/www/cvsroot/FreeBSD/src/usr.sbin/wpa/wpa_supplicant/driver_freebsd.c,v 1.8 2005/08/30 15:59:49 sam Exp $
 */
...
wpa_driver_bsd_set_bssid(void *priv, const char *bssid)
{
	...
	strncpy(bs.i_name, drv->ifname, sizeof(bs.i_name);
	memcpy(bs.i_bssid, bssid, sizeof(bs.i_bssid));
